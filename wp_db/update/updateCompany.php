...
function updateCompany(PDO $pdo, string $taxNumber, string $companyName): string {
  try {
    ...
    $selectCompanyCodeQuery = 'SELECT company_id FROM wp_company WHERE company_name = :cn';
    ...
    $updateNameQuery = 'UPDATE wp_user SET company_code = :cc WHERE user_tax_number = :utn';
